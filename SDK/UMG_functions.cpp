...
// Function UMG.VoidBinding.Execute
// (Final, Native, Public)

void UVoidBinding::Execute()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.VoidBinding.Execute");

	UVoidBinding_Execute_Params params;
