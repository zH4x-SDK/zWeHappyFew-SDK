...
// BlueprintGeneratedClass RottenRawMeat.RottenRawMeat_C
// 0x0008 (0x0878 - 0x0870)
class ARottenRawMeat_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RottenRawMeat.RottenRawMeat_C");
		return ptr;
	}
