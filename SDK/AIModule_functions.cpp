...
// Function AIModule.BTTask_BlueprintBase.RegisterForMessage
// (Final, Native, Protected, BlueprintCallable)
// Parameters:
// struct FName                   Message                        (Parm, ZeroConstructor, IsPlainOldData)

void UBTTask_BlueprintBase::RegisterForMessage(const struct FName& Message)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.BTTask_BlueprintBase.RegisterForMessage");

	UBTTask_BlueprintBase_RegisterForMessage_Params params;
	params.Message = Message;
...
// Function AIModule.BTTask_BlueprintBase.ReceiveMessageAI
...
void UBTTask_BlueprintBase::ReceiveMessageAI(class AAIController* OwnerController, class APawn* ControlledPawn, const struct FName& Message, bool bSuccess)
{
	static auto fn = UObject::FindObject<UFunction>("Function AIModule.BTTask_BlueprintBase.ReceiveMessageAI");

	UBTTask_BlueprintBase_ReceiveMessageAI_Params params;
	params.OwnerController = OwnerController;
	params.ControlledPawn = ControlledPawn;
	params.Message = Message;
	params.bSuccess = bSuccess;
