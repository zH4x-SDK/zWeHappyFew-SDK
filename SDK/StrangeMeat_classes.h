...
// BlueprintGeneratedClass StrangeMeat.StrangeMeat_C
// 0x0008 (0x0878 - 0x0870)
class AStrangeMeat_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass StrangeMeat.StrangeMeat_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_StrangeMeat(int EntryPoint);
};
