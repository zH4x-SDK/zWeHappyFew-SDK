...
// BlueprintGeneratedClass RunningShoes.RunningShoes_C
// 0x000C (0x07BC - 0x07B0)
class ARunningShoes_C : public AGlimpsePickupOutfit
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RunningShoes.RunningShoes_C");
		return ptr;
	}
