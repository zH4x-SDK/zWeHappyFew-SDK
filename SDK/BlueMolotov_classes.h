...
// BlueprintGeneratedClass BlueMolotov.BlueMolotov_C
// 0x0010 (0x0C00 - 0x0BF0)
class ABlueMolotov_C : public AGlimpsePickupWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BlueMolotov.BlueMolotov_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BlueMolotov(int EntryPoint);
};
