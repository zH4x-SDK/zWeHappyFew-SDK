...
struct FAIDynamicParam
{
	...
	TEnumAsByte<EAIParamType>                          ParamType;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
...
struct FEnvNamedValue
{
	...
	TEnumAsByte<EAIParamType>                          ParamType;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Value;                                                    // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
