...
// BlueprintGeneratedClass BandageAntiseptic.BandageAntiseptic_C
// 0x0008 (0x0878 - 0x0870)
class ABandageAntiseptic_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BandageAntiseptic.BandageAntiseptic_C");
		return ptr;
	}
