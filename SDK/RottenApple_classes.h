...
// BlueprintGeneratedClass RottenApple.RottenApple_C
// 0x0008 (0x0878 - 0x0870)
class ARottenApple_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RottenApple.RottenApple_C");
		return ptr;
	}
