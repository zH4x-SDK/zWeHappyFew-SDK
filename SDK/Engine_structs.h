...
// Enum Engine.EProxyMeshComponents
enum class EProxyMeshComponents : uint8_t
{
	EProxyMeshComponents__All      = 0,
	EProxyMeshComponents__Opaque   = 1,
	EProxyMeshComponents__Masked   = 2,
	EProxyMeshComponents__Translucent = 3,
	EProxyMeshComponents__EProxyMeshComponents_MAX = 4
};
...
struct FRepMovement
{
	...
	TEnumAsByte<EVectorQuantization>                   LocationQuantizationLevel;                                // 0x0000(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EVectorQuantization>                   VelocityQuantizationLevel;                                // 0x0000(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
struct FLightingChannels
{
	...
	bool                                               bChannel1;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bChannel2;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
struct FBodyInstance
{
	...
	uint64_t                                           RigidActorSyncId;                                         // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           RigidActorAsyncId;                                        // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x1AF];                                     // 0x0001(0x01AF) MISSED OFFSET
};
...
struct FMovementProperties
{
	...
	unsigned char                                      bCanLean : 1;                                             // 0x0000(0x0001) (Edit, BlueprintVisible)
...
struct FNavAgentProperties : public FMovementProperties
{
	...
	class UClass*                                      PreferredNavData;                                         // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	bool                                               bHasAdditiveSources;                                      // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bHasOverrideSources;                                      // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	struct FVector_NetQuantize10                       LastPreAdditiveVelocity;                                  // 0x0000(0x000C)
	bool                                               bIsAdditiveVelocityApplied;                               // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FRepRootMotionMontage
{
	...
	bool                                               bRelativeRotation;                                        // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	struct FRootMotionSourceGroup                      AuthoritativeRootMotion;                                  // 0x0000(0x0100)
	struct FVector_NetQuantize10                       Acceleration;                                             // 0x0000(0x000C)
	struct FVector_NetQuantize10                       LinearVelocity;                                           // 0x0000(0x000C)
	unsigned char                                      UnknownData00[0x154];                                     // 0x000C(0x0154) MISSED OFFSET
};
...
{
	float                                              time;                                                     // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FRepRootMotionMontage                       RootMotion;                                               // 0x0000(0x0160)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      bOverride_AntiAliasingMethod : 1;                         // 0x0000(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      UnknownData09 : 6;                                        // 0x0000(0x0001)
	...
	unsigned char                                      UnknownData10 : 6;                                        // 0x0000(0x0001)
	...
	unsigned char                                      UnknownData13 : 6;                                        // 0x0000(0x0001)
	...
	unsigned char                                      UnknownData14 : 6;                                        // 0x0000(0x0001)
	unsigned char                                      bOverride_DepthOfFieldBokehShape : 1;                     // 0x0000(0x0001) (Edit, BlueprintVisible)
	struct FWeightedBlendables                         WeightedBlendables;                                       // 0x0000(0x0010) (Edit)
	unsigned char                                      UnknownData15 : 4;                                        // 0x0000(0x0001)
	...
	unsigned char                                      UnknownData16 : 4;                                        // 0x0000(0x0001)
	...
	unsigned char                                      UnknownData17 : 5;                                        // 0x0000(0x0001)
	...
	unsigned char                                      UnknownData18[0x4BF];                                     // 0x0001(0x04BF) MISSED OFFSET
};
...
struct FMinimalViewInfo
{
	...
	struct FPostProcessSettings                        PostProcessSettings;                                      // 0x0000(0x04C0) (BlueprintVisible)
...
struct FCameraCacheEntry
{
	...
	struct FMinimalViewInfo                            POV;                                                      // 0x0000(0x0500)
...
struct FTViewTarget
{
	...
	struct FMinimalViewInfo                            POV;                                                      // 0x0000(0x0500) (Edit, BlueprintVisible)
	class APlayerState*                                PlayerState;                                              // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x518];                                     // 0x0008(0x0518) MISSED OFFSET
};
...
struct FNavDataConfig : public FNavAgentProperties
{
	...
	class UClass*                                      NavigationDataClass;                                      // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	struct FStringClassReference                       NavigationDataClassName;                                  // 0x0000(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData00[0x40];                                      // 0x0010(0x0040) MISSED OFFSET
};
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData01[0x2F];                                      // 0x0001(0x002F) MISSED OFFSET
};
...
struct FSkeletalMaterial
{
	...
	bool                                               bRecomputeTangent;                                        // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0001(0x000F) MISSED OFFSET
};
...
struct FSkeletalMeshOptimizationSettings
{
	...
	TArray<struct FBoneReference>                      BonesToRemove;                                            // 0x0000(0x0010) (ZeroConstructor, Deprecated)
	int                                                BaseLOD;                                                  // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FSkeletalMeshLODInfo
{
	...
	TArray<struct FName>                               RemovedBones;                                             // 0x0000(0x0010) (Edit, ZeroConstructor)
	unsigned char                                      UnknownData00[0x80];                                      // 0x0010(0x0080) MISSED OFFSET
};
...
struct FClothPhysicsProperties
{
	...
	float                                              HorizontalResistance;                                     // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	float                                              MassScale;                                                // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	float                                              SelfCollisionSquashScale;                                 // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	float                                              FiberCompression;                                         // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FiberExpansion;                                           // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FiberResistance;                                          // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FClothingAssetData
{
	...
	struct FClothPhysicsProperties                     PhysicsProperties;                                        // 0x0000(0x0050) (Edit, ZeroConstructor, Transient, IsPlainOldData)
...
struct FSplinePoint
{
	...
	struct FVector                                     ArriveTangent;                                            // 0x0000(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector                                     LeaveTangent;                                             // 0x0000(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<ESplinePointType>                      Type;                                                     // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x43];                                      // 0x0001(0x0043) MISSED OFFSET
};
...
struct FAttenuationSettings
{
	...
	struct FRuntimeFloatCurve                          CustomAttenuationCurve;                                   // 0x0000(0x0080) (Edit, BlueprintVisible)
...
struct FLinearDriveConstraint
{
	...
	struct FVector                                     VelocityTarget;                                           // 0x0000(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
struct FAngularDriveConstraint
{
	...
	struct FRotator                                    OrientationTarget;                                        // 0x0000(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
struct FConstraintInstance
{
	...
	unsigned char                                      UnknownData00[0xEC];                                      // 0x0104(0x00EC) MISSED OFFSET
};
...
{
	struct FRichCurve                                  FloatCurve;                                               // 0x0000(0x0078)
...
struct FPoseData
{
	...
	TArray<bool>                                       LocalSpacePoseMask;                                       // 0x0000(0x0010) (ZeroConstructor)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	TEnumAsByte<EAlphaBlendOption>                     BlendMode;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FLaunchOnTestSettings
{
	...
	struct FString                                     DeviceID;                                                 // 0x0000(0x0010) (Edit, ZeroConstructor, Config)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0010(0x0010) MISSED OFFSET
};
...
struct FFormatArgumentData
{
	...
	struct FText                                       ArgumentValue;                                            // 0x0000(0x0018) (Edit, BlueprintVisible, DisableEditOnTemplate)
	...
	TEnumAsByte<ETextGender>                           ArgumentValueGender;                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3F];                                      // 0x0001(0x003F) MISSED OFFSET
};
...
struct FKBoxElem : public FKShapeElem
{
	struct FMatrix                                     TM;                                                       // 0x0000(0x0040) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FVector                                     Center;                                                   // 0x0000(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	struct FQuat                                       Orientation;                                              // 0x0000(0x0010) (Edit, IsPlainOldData)
...
struct FDialogueContextMapping
{
	...
	struct FString                                     LocalizationKeyFormat;                                    // 0x0000(0x0010) (Edit, ZeroConstructor)
...
struct FHapticFeedbackDetails_Curve
{
	...
	unsigned char                                      UnknownData00[0x80];                                      // 0x0080(0x0080) MISSED OFFSET
};
...
struct FDestructibleDamageParameters
{
	...
	bool                                               bEnableImpactDamage;                                      // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bCustomImpactResistance;                                  // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FDestructibleSpecialHierarchyDepths
{
	...
	bool                                               bEnableDebris;                                            // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FDestructibleParameters
{
	...
	struct FDestructibleSpecialHierarchyDepths         SpecialHierarchyDepths;                                   // 0x0000(0x0014) (Edit)
...
{
	float                                              ScreenSize;                                               // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FSkeletalMeshOptimizationSettings           OptimizationSettings;                                     // 0x0000(0x0040) (Edit)
...
struct FExposedValueCopyRecord
{
	...
	TEnumAsByte<EPostCopyOperation>                    PostCopyOperation;                                        // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	class UBoolProperty*                               CachedBoolSourceProperty;                                 // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FAnimCurveType
{
	...
	bool                                               bEvent;                                                   // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bMaterial;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0001(0x0002) MISSED OFFSET
};
...
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FAnimCurveType                              Type;                                                     // 0x0000(0x0003) (Edit, BlueprintVisible)
...
struct FURL
{
	...
	struct FString                                     RedirectURL;                                              // 0x0000(0x0010) (ZeroConstructor)
...
struct FDamageEvent
{
	...
	int                                                HitReaction;                                              // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bInterruptBarks : 1;                                      // 0x0000(0x0001)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0001(0x0017) MISSED OFFSET
};
...
struct FMeshBuildSettings
{
	...
	bool                                               bBuildAdjacencyBuffer;                                    // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bBuildReversedIndexBuffer;                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseHighPrecisionTangentBasis;                            // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bGenerateDistanceFieldAsIfTwoSided;                       // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimUpdateRateParameters
{
	...
	bool                                               bShouldUseLodMap;                                         // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	TEnumAsByte<EUpdateRateShiftBucket>                ShiftBucket;                                              // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FBPVariableDescription
{
	...
	struct FText                                       Category;                                                 // 0x0000(0x0018) (Edit)
...
{
	class UObject*                                     MemberParent;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     MemberScope;                                              // 0x0000(0x0010) (ZeroConstructor)
	struct FName                                       MemberName;                                               // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FGuid                                       MemberGuid;                                               // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData)
...
struct FMaterialProxySettings
{
	...
	TEnumAsByte<ETextureSizingType>                    TextureSizingType;                                        // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              GutterSpace;                                              // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bNormalMap;                                               // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMetallicMap;                                             // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MetallicConstant;                                         // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRoughnessMap;                                            // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RoughnessConstant;                                        // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSpecularMap;                                             // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpecularConstant;                                         // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEmissiveMap;                                             // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOpacityMap;                                              // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OpacityConstant;                                          // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOpacityMaskMap;                                          // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              OpacityMaskConstant;                                      // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DiffuseTextureSize;                                       // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   NormalTextureSize;                                        // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   MetallicTextureSize;                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   RoughnessTextureSize;                                     // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   SpecularTextureSize;                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   EmissiveTextureSize;                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   OpacityTextureSize;                                       // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   OpacityMaskTextureSize;                                   // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EMaterialMergeType>                    MaterialMergeType;                                        // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlendMode>                            BlendMode;                                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7B];                                      // 0x0001(0x007B) MISSED OFFSET
};
...
struct FMaterialSimplificationSettings
{
	...
	bool                                               bNormalMap;                                               // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   NormalMapSize;                                            // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MetallicConstant;                                         // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMetallicMap;                                             // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   MetallicMapSize;                                          // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RoughnessConstant;                                        // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRoughnessMap;                                            // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   RoughnessMapSize;                                         // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpecularConstant;                                         // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSpecularMap;                                             // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   SpecularMapSize;                                          // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0008(0x003C) MISSED OFFSET
};
...
struct FLevelSimplificationDetails
{
	...
	struct FMaterialSimplificationSettings             StaticMeshMaterial;                                       // 0x0000(0x0044) (Deprecated)
	struct FMaterialProxySettings                      StaticMeshMaterialSettings;                               // 0x0000(0x007C) (Edit)
	...
	struct FMaterialSimplificationSettings             LandscapeMaterial;                                        // 0x0000(0x0044) (Deprecated)
	struct FMaterialProxySettings                      LandscapeMaterialSettings;                                // 0x0000(0x007C) (Edit)
	...
	unsigned char                                      UnknownData00[0x19B];                                     // 0x0001(0x019B) MISSED OFFSET
};
...
struct FMeshMergingSettings
{
	...
	int                                                TargetLightMapUVChannel;                                  // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                TargetLightMapResolution;                                 // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bImportVertexColors;                                      // 0x0000(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bPivotPointAtZero;                                        // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMergePhysicsData;                                        // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreNoCollisionPhysics;                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMergeMaterials;                                          // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x0000(0x007C) (Edit)
	bool                                               bBakeVertexDataToMesh;                                    // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseVertexDataForBakingMaterial;                          // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCalculateCorrectLODModel;                                // 0x0000(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	TEnumAsByte<EMeshLODSelectionType>                 LODSelectionType;                                         // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ExportSpecificLOD;                                        // 0x0000(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	int                                                SpecificLOD;                                              // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeCulling;                                     // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0xA8];                                      // 0x0004(0x00A8) MISSED OFFSET
};
...
struct FMeshProxySettings
{
	...
	unsigned char                                      bGenerateScreenSize : 1;                                  // 0x0000(0x0001) (Edit)
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x0000(0x007C) (Edit)
	...
	bool                                               bExportRoughnessMap;                                      // 0x0000(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportSpecularMap;                                       // 0x0000(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FMaterialSimplificationSettings             Material;                                                 // 0x0000(0x0044) (Deprecated)
	TEnumAsByte<EProxyMeshComponents>                  ComponentsToMerge;                                        // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MeshCullSize;                                             // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIncludeInvisible;                                        // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIncludeHiddenInGame;                                     // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCalculateCorrectLODModel;                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MergeDistance;                                            // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HardAngleThreshold;                                       // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                LightMapResolution;                                       // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bUseLandscapeCulling;                                     // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELandscapeCullingPrecision>            LandscapeCullingPrecision;                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bGenerateCullingForAbove;                                 // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FName                                       ProxyGroup;                                               // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMeshReductionSettings
{
	...
	TEnumAsByte<EMeshFeatureImportance>                VertexColorImportance;                                    // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1F];                                      // 0x0001(0x001F) MISSED OFFSET
};
...
struct FHierarchicalSimplification
{
	...
	struct FMeshProxySettings                          ProxySetting;                                             // 0x0000(0x0100) (Edit)
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x0000(0x00AC) (Edit)
	...
	unsigned char                                      UnknownData00[0x1C4];                                     // 0x0004(0x01C4) MISSED OFFSET
};
...
struct FRootMotionSource
{
	...
	TEnumAsByte<ERootMotionAccumulateMode>             AccumulateMode;                                           // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	bool                                               bImpartsVelocityOnRemoval;                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FVectorCurve                                TranslationCurve;                                         // 0x0000(0x0188)
	struct FVectorCurve                                RotationCurve;                                            // 0x0000(0x0188)
	struct FVectorCurve                                ScaleCurve;                                               // 0x0000(0x0188)
	unsigned char                                      UnknownData00[0x330];                                     // 0x0188(0x0330) MISSED OFFSET
};
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData00[0x198];                                     // 0x0038(0x0198) MISSED OFFSET
};
...
struct FEdGraphSchemaAction
{
	...
	struct FText                                       Category;                                                 // 0x0000(0x0018)
	struct FText                                       Keywords;                                                 // 0x0000(0x0018)
	int                                                Grouping;                                                 // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SectionID;                                                // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FString>                             MenuDescriptionArray;                                     // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FString>                             FullSearchTitlesArray;                                    // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FString>                             FullSearchKeywordsArray;                                  // 0x0000(0x0010) (ZeroConstructor)
	TArray<struct FString>                             FullSearchCategoryArray;                                  // 0x0000(0x0010) (ZeroConstructor)
	struct FString                                     SearchText;                                               // 0x0000(0x0010) (ZeroConstructor)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	class UAnimSequenceBase*                           LastSequence;                                             // 0x0000(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
{
	struct FPoseLink                                   InPose;                                                   // 0x0000(0x0018)
...
{
	unsigned char                                      UnknownData00[0x390];                                     // 0x0000(0x0390) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x130];                                     // 0x0390(0x0130) MISSED OFFSET
};
