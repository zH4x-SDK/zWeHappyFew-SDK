...
struct ARottenPotato_C_UserConstructionScript_Params
{
};
...
struct ARottenPotato_C_BndEvt__InteractionComponent_K2Node_ComponentBoundEvent_24_InteractionSignature__DelegateSignature_Params
{
	class APawn*                                       InteractSource;                                           // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function RottenPotato.RottenPotato_C.ReceiveOnCompleteUse
struct ARottenPotato_C_ReceiveOnCompleteUse_Params
{
...
struct ARottenPotato_C_ExecuteUbergraph_RottenPotato_Params
{
