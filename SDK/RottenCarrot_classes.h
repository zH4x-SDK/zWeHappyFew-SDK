...
// BlueprintGeneratedClass RottenCarrot.RottenCarrot_C
// 0x0008 (0x0878 - 0x0870)
class ARottenCarrot_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RottenCarrot.RottenCarrot_C");
		return ptr;
	}
