...
class ARawMeat_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RawMeat.RawMeat_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_RawMeat(int EntryPoint);
};
