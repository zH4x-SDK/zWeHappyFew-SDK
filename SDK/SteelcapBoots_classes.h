...
// BlueprintGeneratedClass SteelcapBoots.SteelcapBoots_C
// 0x000C (0x07BC - 0x07B0)
class ASteelcapBoots_C : public AGlimpsePickupOutfit
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SteelcapBoots.SteelcapBoots_C");
		return ptr;
	}
