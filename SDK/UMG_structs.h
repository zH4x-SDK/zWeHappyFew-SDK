...
struct FShapedTextOptions
{
	...
	TEnumAsByte<ETextShapingMethod>                    TextShapingMethod;                                        // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextFlowDirection>                    TextFlowDirection;                                        // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
struct FDelegateRuntimeBinding
{
	...
	struct FDynamicPropertyPath                        SourcePath;                                               // 0x0000(0x0010)
