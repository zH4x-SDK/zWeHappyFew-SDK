...
// BlueprintGeneratedClass ArmyBoots.ArmyBoots_C
// 0x000C (0x07BC - 0x07B0)
class AArmyBoots_C : public AGlimpsePickupOutfit
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ArmyBoots.ArmyBoots_C");
		return ptr;
	}
