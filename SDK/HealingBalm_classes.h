...
// BlueprintGeneratedClass HealingBalm.HealingBalm_C
// 0x0008 (0x0878 - 0x0870)
class AHealingBalm_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass HealingBalm.HealingBalm_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_HealingBalm(int EntryPoint);
};
