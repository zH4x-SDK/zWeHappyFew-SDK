...
struct FPartyReservation
{
	...
	struct FUniqueNetIdRepl                            PartyLeader;                                              // 0x0000(0x0018) (Transient)
...
struct FPIELoginSettingsInternal
{
	...
	struct FString                                     Token;                                                    // 0x0000(0x0010) (Edit, ZeroConstructor, Transient)
	struct FString                                     Type;                                                     // 0x0000(0x0010) (Edit, ZeroConstructor)
