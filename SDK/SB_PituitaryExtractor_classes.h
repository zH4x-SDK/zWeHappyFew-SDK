...
// BlueprintGeneratedClass SB_PituitaryExtractor.SB_PituitaryExtractor_C
// 0x0020 (0x0820 - 0x0800)
class ASB_PituitaryExtractor_C : public AGlimpsePickupUsable
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass SB_PituitaryExtractor.SB_PituitaryExtractor_C");
		return ptr;
	}
