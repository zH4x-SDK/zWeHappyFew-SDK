...
// BlueprintGeneratedClass CricketBatPadded.CricketBatPadded_C
// 0x0010 (0x0C00 - 0x0BF0)
class ACricketBatPadded_C : public AGlimpsePickupWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass CricketBatPadded.CricketBatPadded_C");
		return ptr;
	}
