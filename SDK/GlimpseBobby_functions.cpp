...
struct FName AGlimpseBobby_C::ChooseAttack(class AGlimpseCharacter** Target, float* TargetDistance, TEnumAsByte<EGlimpseCombatRange>* CombatRange)
{
	static auto fn = UObject::FindObject<UFunction>("Function GlimpseBobby.GlimpseBobby_C.ChooseAttack");

	AGlimpseBobby_C_ChooseAttack_Params params;
