...
// BlueprintGeneratedClass FlamingLeadPipe_Weak.FlamingLeadPipe_Weak_C
// 0x0040 (0x0C30 - 0x0BF0)
class AFlamingLeadPipe_Weak_C : public AGlimpsePickupWeapon
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FlamingLeadPipe_Weak.FlamingLeadPipe_Weak_C");
		return ptr;
	}
