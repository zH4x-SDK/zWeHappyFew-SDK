...
// BlueprintGeneratedClass RidingBoots.RidingBoots_C
// 0x000C (0x07BC - 0x07B0)
class ARidingBoots_C : public AGlimpsePickupOutfit
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RidingBoots.RidingBoots_C");
		return ptr;
	}
