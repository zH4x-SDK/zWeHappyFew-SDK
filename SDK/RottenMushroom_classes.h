...
// BlueprintGeneratedClass RottenMushroom.RottenMushroom_C
// 0x0008 (0x0878 - 0x0870)
class ARottenMushroom_C : public AGlimpsePickupSurvival
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RottenMushroom.RottenMushroom_C");
		return ptr;
	}
